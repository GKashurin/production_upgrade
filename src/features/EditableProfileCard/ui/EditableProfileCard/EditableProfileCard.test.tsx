...
describe('features/EditableProfileCard', () => {
  ...
  test('При отмене значения обнуляются', async () => {
    ...
    await userEvent.click(screen.getByTestId('EditableProfileCardHeader.CancelButton')); // нажимаю кнопку отмены
  ...
  test('Должна появиться ошибка', async () => {
    ...
    await userEvent.click(screen.getByTestId('EditableProfileCardHeader.SaveButton')); // нажимаю кнопку сохранения
    expect(screen.getByTestId('EditableProfileCard.Error.paragraph')).toBeInTheDocument() // жду ошибку
  });
